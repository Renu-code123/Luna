  ...
  return (
    <div className="max-w-md mx-auto py-8 px-4">
      <div className="neon-card flex flex-col items-center">
        <div className="w-14 h-14 rounded-2xl border-2 border-neon-pink flex items-center justify-center neon-shadow-pink mb-4">
          <Shield size={28} className="text-neon-pink" />
        </div>
        <h2 className="text-2xl font-bold mb-1">
          <span className="text-neon-pink neon-text">Create</span> Profile
        </h2>
        <p className="text-xs text-gray-400 mb-6 text-center">Join Luna Healthcare AI today.</p>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-3">
          ...
          <button type="submit" className="w-full neon-button neon-button-pink mt-2 py-2.5">
            Sign Up
          </button>
        </form>
        ...
        <div className="mt-4 text-xs text-gray-400">
          ...
          <button onClick={() => setActiveTab('login')} className="text-neon-blue hover:underline font-semibold">
            Log In
          </button>
        </div>
      </div>
